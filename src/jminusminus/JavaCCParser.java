...
class JavaCCParser implements JavaCCParserConstants {
  ...
  final private JClassDeclaration classDeclaration(ArrayList<String> mods) throws ParseException {
    ...
    ArrayList<JBlock> SIB = new ArrayList<JBlock>();
    ...
    try {
      ...
      classBody = classBody(SIB,IIB);
    } catch (ParseException e) {
        recoverFromError(new int[] { SEMI, EOF }, e);
    }
        {if (true) return new JClassDeclaration(line, mods, name, superClass, classBody, SIB, IIB);}
    throw new Error("Missing return statement in function");
  }

  final private ArrayList<JMember> classBody(ArrayList<JBlock> SIB, ArrayList<JBlock> IIB) throws ParseException {
    ArrayList<String> mods = null;
  ...
  final private JInterfaceDeclaration interfaceDeclaration(ArrayList<String> mods) throws ParseException {
    int line = 0;
    String name = "";
    ArrayList<TypeName> superClasses = new ArrayList<TypeName>();
    ...
    try {
      ...
      interfaceBody = interfaceBody();
        ...
        {if (true) return new JInterfaceDeclaration(line, mods, name, superClasses, interfaceBody);}
    throw new Error("Missing return statement in function");
  }
  ...
  final private JMember interfaceMemberDecl(ArrayList<String> mods) throws ParseException {
    ...
    try {
      ...
      {if (true) return interfaceMemberDecl;}
    throw new Error("Missing return statement in function");
  }
  ...
  final private JStatement statement() throws ParseException {
    ...
    JFormalParameter catchParam = null;
    ...
    try {
      ...
      case TRY:
        ...
        if (jj_2_11(2147483647)) {
          ...
          statement = new JTryCatchStatement(line, tryBlock, catchParam, catchBlock, finallyBlock);
        break;
      case THROW:
    ...
    try {
      ...
      case SHL_ASSIGN:
        ...
        case MULT_ASSIGN:
          ...
          rhs = assignmentExpression();
              lhs = new JMultiplyAssignOp(line, lhs, rhs);
          break;
        case DIV_ASSIGN:
          jj_consume_token(DIV_ASSIGN);
          rhs = assignmentExpression();
              lhs = new JDivideAssignOp(line, lhs, rhs);
          break;
        case REM_ASSIGN:
          jj_consume_token(REM_ASSIGN);
          rhs = assignmentExpression();
              lhs = new JRemainderAssignOp(line, lhs, rhs);
          break;
        case AND_ASSIGN:
        ...
        case SHL_ASSIGN:
          ...
          rhs = assignmentExpression();
              lhs = new JShiftLeftAssignOp(line, lhs, rhs);
          break;
        case SHR_ASSIGN:
          jj_consume_token(SHR_ASSIGN);
          rhs = assignmentExpression();
              lhs = new JShiftRightAssignOp(line, lhs, rhs);
          break;
        case USHR_ASSIGN:
          jj_consume_token(USHR_ASSIGN);
          rhs = assignmentExpression();
              lhs = new JUnsignedShiftRightAssignOp(line, lhs, rhs);
          break;
        default:
          jj_la1[39] = jj_gen;
          jj_consume_token(-1);
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x0,0x40000000,0x4080,0x80,0x80,0x20000000,0x200000,0x82180,0x82180,0x200000,0x82180,0x82100,0x0,0x0,0x82100,0x0,0x82100,0x0,0x0,0x82100,0x10482100,0x10400000,0x400000,0x400000,0x10400000,0x0,0x82100,0x0,0x0,0x400000,0x0,0x400000,0x0,0x400000,0x82100,0x82100,0x0,0x0,0x82100,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x80000000,0x0,0x0,0x0,0x400000,0x0,0x400000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x400000,0x82100,0x0,0x0,0x0,0x400000,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x40,0x0,0x1380,0x1380,0x1380,0x0,0x0,0x801381,0x801381,0x0,0x801381,0x800001,0x0,0x0,0x1,0x0,0x800001,0x0,0x0,0x1,0x12664431,0x12664430,0x10224030,0x10224030,0x12664430,0x0,0x1,0x0,0x8000000,0x10224030,0x0,0x10224030,0x0,0x10224030,0x1,0x1,0x0,0x0,0x1,0x8000000,0x8000000,0x0,0x0,0x60000000,0x60000000,0x80000000,0x80000000,0x4000000,0x4000000,0x0,0x10224030,0x0,0x224030,0x0,0x10000000,0x10000000,0x0,0x0,0x0,0x0,0x0,0x0,0x224030,0x1,0x0,0x0,0x0,0x200020,};
   }
   private static void jj_la1_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8080000,0x8080000,0x0,0x8000000,0x8000000,0x2000000,0x1080000,0x8000000,0x2000000,0x8000000,0x2000000,0x1080000,0x8000000,0x890a0019,0x890a0019,0x88020019,0x88020019,0x890a0019,0x2000000,0x8000000,0x2000000,0x0,0x880a0019,0x2000000,0x880a0019,0x2000000,0x88020019,0x0,0x0,0x200000,0x200000,0x8000000,0x1ffc0,0x1ffc0,0x2,0x2,0x0,0x0,0x4,0x4,0x10,0x10,0x20,0x88020019,0x8,0x88020000,0x4200000,0x1,0x1,0x20000,0x4200000,0x20000,0x20000,0x4020000,0x20000,0x88020000,0x8000000,0x80000,0x20000,0x200000,0x80000000,};
   }
   private static void jj_la1_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x7,0x7,0x7,0x7,0x7,0x0,0x0,0x0,0x0,0x7,0x0,0x7,0x0,0x7,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x7,0x0,0x7,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x7,0x0,0x0,0x0,0x0,0x7,};
   }
